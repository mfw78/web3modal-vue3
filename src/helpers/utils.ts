...
export function getProviderInfoFromChecksArray(checks: string[]) {
    const check = filterProviderChecks(checks);
    return filterProviders("check", check);
}

export function getProviderInfoByName(name: string) {
    return filterProviders("name", name);
}

export function getProviderInfoById(id: string) {
    return filterProviders("id", id);
}

export function getProviderInfoByCheck(check: string) {
    return filterProviders("check", check);
}
...
export function getProviderDescription(providerInfo: ProviderInfo) {
...
export function filterMatches(array: any[], condition: any, fallback: any) {
    let result = fallback;
...
export function filterProviders(param: string, value: string) {
...
export function filterProviderChecks(checks: string[]) {
...
export function findMatchingRequiredOptions(
    ...
    const matches: string[] = requiredOptions.filter((requiredOption: string) => {
